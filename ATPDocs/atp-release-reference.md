...
Dieser Artikel ist eine Referenz zu allen Azure ATP-Versionen bis (und einschließlich) von Version 2.55. Informationen zu aktuellen Azure ATP-Versionsupdates (2.56 und höher) finden Sie unter [Neuerungen in Azure ATP](atp-whats-new.md).
...
Die **externalId**-Zuordnung sowie zusätzliche Erläuterungen wurden den Beschreibungen des SIEM-Protokolls hinzugefügt. Weitere Informationen finden Sie in der [Referenz zum SIEM-Protokoll](cef-format-sa.md).
    ...
    Es wurde ein neuer Artikel zum Leitfaden für derzeit bekannte Probleme hinzugefügt. Weitere Informationen finden Sie unter: [Azure ATP Known Issues (Azure ATP: Bekannte Probleme)](troubleshooting-atp-known-issues.md).
