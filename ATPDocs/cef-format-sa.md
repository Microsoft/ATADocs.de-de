...
|[Vermuteter Skeleton-Key-Angriff (Herabstufung der Verschlüsselung)](atp-domain-dominance-alerts.md#suspected-skeleton-key-attack-encryption-downgrade-external-id-2010)|Aktivität zur Herabstufung der Verschlüsselung (potenzieller Skeleton Key-Angriff)|2010|
...
### <a name="malicious-request-of-data-protection-api-master-key"></a>Böswillige Anforderung eines Masterschlüssels zur Datenschutz-API 
...
### <a name="network-mapping-reconnaissance-dns"></a>Reconnaissance über Netzwerkzuordnung (DNS)
...
### <a name="remote-code-execution-over-dns---preview"></a>Remote-Codeausführung über DNS – Vorschau
...
### <a name="suspected-brute-force-attack-ldap"></a>Vermuteter Brute-Force-Angriff (LDAP)
...
### <a name="suspected-brute-force-attack-kerberos-ntlm"></a>Vermuteter Brute-Force-Angriff (Kerberos NTLM)
...
### <a name="suspected-golden-ticket-usage-non-existent-account"></a>Vermutete Golden Ticket-Verwendung (nicht vorhandenes Konto)
...
### <a name="suspected-golden-ticket-usage-ticket-anomaly"></a>Vermutete Golden Ticket-Verwendung (Ticketanomalie) 
...
### <a name="suspected-golden-ticket-usage-time-anomaly"></a>Vermutete Golden Ticket-Verwendung (Zeitanomalie) 
...
### <a name="suspected-golden-ticket-usage-forged-authorization-data"></a>Vermutete Golden Ticket-Verwendung (gefälschte Autorisierungsdaten) 
...
### <a name="suspected-identity-theft-pass-the-hash"></a>Vermuteter Identitätsdiebstahl (Pass-the-Hash)
...
### <a name="suspected-identity-theft-pass-the-ticket"></a>Vermuteter Identitätsdiebstahl (Pass-the-Ticket) 
...
### <a name="suspected-over-pass-the-hash-attack-encryption-downgrade"></a>Vermuteter Over-Pass-the-Hash-Angriff (Herabstufung der Verschlüsselung) 
...
### <a name="suspected-skeleton-key-attack-encryption-downgrade"></a>Vermuteter Skeleton-Key-Angriff (Herabstufung der Verschlüsselung) 
...
### <a name="suspected-dcsync-attack-replication-of-directory-services"></a>Vermuteter DCSync-Angriff (Replikation von Verzeichnisdiensten)
...
### <a name="suspected-wannacry-ransomware-attack"></a>Vermuteter WannaCry-Ransomware-Angriff
...
### <a name="suspected-brute-force-attack-smb"></a>Vermuteter Brute-Force-Angriff (SMB)
...
### <a name="suspected-use-of-metasploit-hacking-framework"></a>Vermutete Verwendung des Metasploit-Hackerframeworks
...
### <a name="suspected-overpass-the-hash-attack-kerberos"></a>Vermuteter Overpass-the-Hash-Angriff (Kerberos)
