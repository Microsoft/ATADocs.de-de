...
> [!NOTE]
> Wenn ATA in Ihrer Umgebung nicht installiert ist, downloaden Sie die vollständige Version des ATA (enthält Version 1.5), und befolgen Sie die in [ATA installieren](install-ata.md) beschriebene Standardinstallation.
