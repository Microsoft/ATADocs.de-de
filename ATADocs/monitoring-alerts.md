...
### Der Speicherplatz für ATA Center reicht nicht aus.
...
### Fehler bei der Verbindungsherstellung mit dem SIEM-Server unter Verwendung von Syslog.
...
### Das ATA Center-Zertifikat läuft bald ab.
...
## Probleme mit dem ATA-Gateway
<a id="ata-gateway-issues" class="xliff"></a>
### Read-only user password is about to expire. (Das schreibgeschützte Benutzerkennwort läuft ab.)
...
### Kennwort für schreibgeschützten Benutzer abgelaufen
...
### Das ATA-Gatewayzertifikat läuft bald ab
...
### Domain synchronizer not assigned (Domänensynchronizer nicht zugewiesen)
...
### Alle/Einige der Netzwerkdatenerfassungs-Adapter auf dem ATA-Gateway sind nicht verfügbar
...
### Einige Domänencontroller sind für ein ATA-Gateway unerreichbar.
...
### Alle Domänencontroller sind für das ATA-Gateway unerreichbar
...
### ATA-Gateway hat Kommunikation eingestellt
...
### Der ATA-Gatewaydienst konnte nicht gestartet werden
...
### Das ATA-Lightweight-Gateway hat ein Arbeitsspeicher-Ressourcenlimit erreicht
